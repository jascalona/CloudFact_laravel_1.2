                                                    ...
                                                    <div class="tab-content pt-5" id="tab-content">
                                                        ...
                                                        <div class="tab-pane active w-100" id="fill-tabpanel-0"
                                                            ...
                                                            <div class="cont" id="show_global">
                                                                ...
                                                                <div class="form-text" id="basic-addon4">Copiado Minimo Contratado B/N</div>
                                                                <div class="input-group mb-3">
                                                                ...
                                                                <div class="form-text" id="basic-addon4">Copiado Minimo Contratado Color</div>
                                                                <div class="input-group mb-3">
                                                                    <input type="number"  class="form"
                                                                        placeholder="2500" aria-label="Username"
                                                                        aria-describedby="basic-addon1" value="0">
                                                                ...
                                                                <div class="form-text" id="basic-addon4">Precio Cargo Minimo</div>
                                                                <div class="input-group mb-3">
                                                                    <input type="number"  class="form"
